...
client.on("ready", () => {
    ...
    client.user.setActivity("Checking mails for propaganda")
})
...
client.on("channelDelete", (channel) => {
    if (channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
        ...
        let yembed = new discord.MessageEmbed()
            ...
            .setColor('RED')
            .setDescription("Ticket has been closed, please dont not respond to this message until you need any more help")
    ...
    if (!message.guild) {
        ...
        if (!main) {
            ...
            let sembed = new discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setThumbnail(client.user.displayAvatarURL())
                .setDescription("Conversation is now started, you will be contacted by History of Everything free moderator soon")
